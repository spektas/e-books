package com.getir.ebooks.swagger;
...
public class SwaggerConfig {
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("e-books-api")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.getir.ebooks"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("sema", "", "zeynepsemaozdemir@gmail.com"))
